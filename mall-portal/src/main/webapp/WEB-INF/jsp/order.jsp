...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/front/my_add_css/css/car/base.css">
	<link rel="stylesheet" type="text/css" href="${ctx}/static/front/my_add_css/css/car/home.css">
...
<div class="center" style="background:#fff">
	...
	<div class="border_top_cart">
							...
							<div class="box-bd">
								...
								<c:forEach items="${shippings}" var="shippings">
									...
									<input id="checkbox${shippings.id}" name="selectCheckbox" type="checkbox">
										...
										<dd>
											<p class="tel itemTel">${shippings.receiverPhone}</p>
											<p class="itemRegion">${shippings.receiverCity}&nbsp;${shippings.receiverDistrict}</p>
											<p class="itemStreet">${shippings.receiverCity}&nbsp;${shippings.receiverDistrict}${shippings.receiverAddress}</p>
									...
									<div class="item use-new-addr"  id="J_useNewAddr" data-state="off">
										<span class="iconfont icon-add"><img src="${ctx}/static/front/my_add_img/img/add_cart.png" /></span>
										使用新地址
									</div>
								</div>
								...
								<div class="box-bd">
												...
												<div class="col col-1">
													...
													<div class="g-info">
														<a href="#" target="_blank">
															...
															${cartItemVo.product.name}&nbsp;&nbsp;${cartItemVo.product.subtitle}
														</a>
													</div>
												</div>
									...
									<div class="checkout-count clearfix">
										...
										<div class="checkout-price">
											...
											<p class="checkout-total">应付总额：<span><strong id="totalPriceTwo"></strong>元</span></p>
										</div>
										<!--  -->
									</div>
								</div>
		...
		<%-- <script src="${ctx}/static/front/my_add_js/js/base.min.js"></script> --%>

		<%-- <script type="text/javascript" src="${ctx}/static/front/my_add_js/js/address_all.js"></script>
		<script type="text/javascript" src="${ctx}/static/front/my_add_js/js/checkout.min.js"></script> --%>
	</div>
	<!--收货地址body部分结束-->
</div>
