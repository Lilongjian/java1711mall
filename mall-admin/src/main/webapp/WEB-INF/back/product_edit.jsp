<%@ page language="java" contentType="text/html; charset=utf-8"
 ...
 <body>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="subtitle" value="${product.subtitle}" autocomplete="off" placeholder="请输入商品副标题" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="price" value="${product.price}" autocomplete="off" placeholder="请输入商品价格" class="layui-input">
    </div>
  </div>
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="stock" value="${product.stock}" autocomplete="off" placeholder="请输入商品库存" class="layui-input">
    </div>
  </div>
